...
function getHtmlCode(markdownSource)
{
    ...
    contentsArr = contentsArr.map((content, index) => {
        ...
        if ( match )
        {
            ...
            const path = name.replace('pages/components/', 'app-orig/main/documentation/material-ui-components/components/');
            return (
                `\n<FuseExample
                    className="my-24"
                    iframe={${iframe}}
...
{
    // const importPath = 'import %s from \'app-orig/main/documentation/material-ui-components/pages/%s\';';
    ...
    const routeObject = "{ path     : '/documentation/material-ui-components/%s', component: React.lazy(() => import('app-orig/main/documentation/material-ui-components/pages/%p'))}";
    ...
    filewalker(demoDir, function (err, list) {
        ...
        list.forEach(function (file) {
            ...
            const result = fileSource
                .replace(new RegExp('docs/src/modules/utils/compose', 'g'), 'app-orig/main/documentation/material-ui-components/compose')
