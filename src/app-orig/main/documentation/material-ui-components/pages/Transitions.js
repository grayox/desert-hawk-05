...
`}
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transitions/SimpleCollapse.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transitions/SimpleCollapse.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transitions/SimpleFade.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transitions/SimpleFade.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transitions/SimpleGrow.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transitions/SimpleGrow.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transitions/SimpleSlide.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transitions/SimpleSlide.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transitions/SimpleZoom.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transitions/SimpleZoom.js')}
                    /></Typography>
