            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transfer-list/TransferList.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transfer-list/TransferList.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app-orig/main/documentation/material-ui-components/components/transfer-list/SelectAllTransferList.js').default}
                        raw={require('!raw-loader!app-orig/main/documentation/material-ui-components/components/transfer-list/SelectAllTransferList.js')}
                    /></Typography>
