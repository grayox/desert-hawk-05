...
import {setDefaultSettings, setInitialSettings} from 'app-orig/store/actions/fuse';
import _ from '@lodash';
import store from 'app-orig/store';
import * as Actions from 'app-orig/store/actions';
import firebase from 'firebase/app';
import firebaseService from 'app-orig/services/firebaseService';
import auth0Service from 'app-orig/services/auth0Service';
import jwtService from 'app-orig/services/jwtService';
